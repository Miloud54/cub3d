...
/*   Updated: 2025/12/01 14:12:15 by edidier          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					compute_draw_limits(t_game *game, t_ray *ray,
							t_draw *draw);
...
int						append_map_line(t_list **lines, char *line,
							int *max_width);
...
// Texture functions
int						load_one_texture(t_game *game, char *path,
							t_tex_load *tex);
